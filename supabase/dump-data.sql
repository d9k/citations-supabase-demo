...
INSERT INTO "auth"."users" ("instance_id", "id", "aud", "role", "email", "encrypted_password", "email_confirmed_at", "invited_at", "confirmation_token", "confirmation_sent_at", "recovery_token", "recovery_sent_at", "email_change_token_new", "email_change", "email_change_sent_at", "last_sign_in_at", "raw_app_meta_data", "raw_user_meta_data", "is_super_admin", "created_at", "updated_at", "phone", "phone_confirmed_at", "phone_change", "phone_change_token", "phone_change_sent_at", "email_change_token_current", "email_change_confirm_status", "banned_until", "reauthentication_token", "reauthentication_sent_at", "is_sso_user", "deleted_at") VALUES
	...
	('00000000-0000-0000-0000-000000000000', 'b5f563a3-b794-49d0-a0e3-dbf9fffd2321', 'authenticated', 'authenticated', 'd9k@ya.ru', '$2a$10$BNL19FnvkC6EyYVshokk.e1R3HwylfiHqAp/PEtQY49PgNHxf0Nk2', '2023-11-30 13:20:52.160287+00', NULL, '', '2023-11-30 13:19:57.235919+00', '', '2024-01-14 15:27:48.901404+00', '', '', NULL, '2024-01-14 15:28:51.02278+00', '{"provider": "email", "providers": ["email"], "profile_id": 1, "claim_edit_all_profiles": 1}', '{}', NULL, '2023-11-30 13:19:57.22183+00', '2024-01-14 15:42:14.797616+00', NULL, NULL, '', '', NULL, '', 0, NULL, '', NULL, false, NULL);
...
INSERT INTO "public"."country" ("id", "name", "created_at", "updated_at", "found_year", "next_rename_year", "created_by", "updated_by") VALUES
	...
	(10, 'Russia', '2023-12-21 10:02:21.791404+00', '2023-12-26 19:42:07.027739+00', NULL, NULL, 1, 1),
	(7, 'Arztocka', '2023-12-20 15:31:38.442098+00', '2023-12-30 17:55:51.389675+00', NULL, NULL, 1, 1);
...
SELECT pg_catalog.setval('"auth"."refresh_tokens_id_seq"', 1211, true);
