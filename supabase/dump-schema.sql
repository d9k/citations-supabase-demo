...
ALTER TABLE ONLY "public"."citations"
    ADD CONSTRAINT "citations_author_id_fkey" FOREIGN KEY ("author_id") REFERENCES "public"."authors"("id") ON UPDATE CASCADE ON DELETE RESTRICT;

ALTER TABLE ONLY "public"."province"
    ADD CONSTRAINT "province_country_id_fkey" FOREIGN KEY ("country_id") REFERENCES "public"."country"("id") ON UPDATE CASCADE ON DELETE RESTRICT;

ALTER TABLE ONLY "public"."town"
    ADD CONSTRAINT "town_province_id_fkey" FOREIGN KEY ("province_id") REFERENCES "public"."province"("id") ON UPDATE CASCADE ON DELETE RESTRICT;
